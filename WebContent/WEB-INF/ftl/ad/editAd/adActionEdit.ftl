...
<div class="cont">
    <form method="post" id="modifyForm" name="modifyForm" action="doAdActionEdit.html">
        ...
        <div class="grtba">
            ...
            <div style="clear:both;height:10px"></div>
            <div style="padding: 8px 8px 8px 2%;<#if adType?string == '1' >display:none;</#if>" id="detailTitle" ><span class="t_s02">* </span><a id="detailId" style="cursor: pointer;" onclick="openDetail()" >進階設定+</a></div>
