...
<#elseif adStyle == "TMG">
<script language="JavaScript" src="<@s.url value="/" />html/js/ad/adEditTmg.js?t=20180214" ></script>
</#if>

<div class="cont">
<#if adStyle == "TXT">
    <form method="post" id="modifyForm" name="modifyForm" action="doAdAdEditTmg.html">
<#elseif adStyle == "TMG">
    <form method="post" id="modifyForm" name="modifyForm" enctype="multipart/form-data" action="doAdAdEditTmg.html">
</#if>
