					...
					<tr>
						...
						<td style="background:#f9f9f9;">
							<span class="imgar" style="width:100%;">
								<span style="display:block;width:115px;float:left"><img class="img" id="imghead" style="width:90px;height:90px" src="${adDetailContent[0]!}" onerror="this.src='<@s.url value="/" />html/img/upl9090.gif'" style="width:90px;height:90px"></span>                    	
								<!--上傳圖片start-->
