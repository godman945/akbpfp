...
<div class="cont">
    <form method="post" id="modifyForm" name="modifyForm" action="doAdGroupEdit.html">
		<h1 class="adtitle"><span>廣告：</span> ${adActionName!}</h1>
		<h2>
			<div class="cal">帳戶名稱：${customer_info_title!}</div>
			<img vspace="12" hspace="2" align="absmiddle" src="<@s.url value="/" />html/img/iconcr.gif">修改分類
		</h2>
		<div class="grtba">
			<h4>分類</h4>
			...
			<table width="100%" cellspacing="1" cellpadding="0" border="0" class="tb02">
	        	<tbody>
	                ...
	                <tr id="channelTr" >
	                    ...
	                    <td>
	                    	<b>聯播網廣告出價金額NT$<input type="text" style="width:50px" id="adGroupChannelPrice" name="adGroupChannelPrice" value="${adGroupChannelPrice?number!}" maxlength="6"><div id="errorMsg" style="color:red;margin-left:10px;display:inline;"></div>，系統預估播出率:<span id="showRate" name="showRate">${AdAsideRate!}%</span>，系統建議出價NT$ ${sysChannelPrice!} </b>
