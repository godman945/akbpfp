...
<#elseif adStyle == "TMG">
    <form method="post" id="modifyForm" name="modifyForm" enctype="multipart/form-data" action="doAdAdAddTmg.html">
		...
		<ul class="admenuul">
            <li class="m01"><a href="adAddImg.html?adGroupSeq=${adGroupSeq!}&adHiddenType=${adHiddenType!}" onClick="return(chkLeave())">圖像廣告</a></li>
            <li class="m02"><a href="adAdAdd.html?adGroupSeq=${adGroupSeq!}&adHiddenType=${adHiddenType!}" class="active" onClick="return(chkLeave())">圖文廣告</a></li>
