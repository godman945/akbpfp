...
<link type="text/css" rel="stylesheet" href="<@s.url value="/html/css/ad/adAdAddManyURL.css?t=20180423001" />" /> 

<#if adStyle == "TXT">
	<script language="JavaScript" src="<@s.url value="/" />html/js/ad/adAddTxt.js" ></script>
<#elseif adStyle == "TMG">
	<script language="JavaScript" src="<@s.url value="/" />html/js/ad/adAddTmg.js?t=20180801001" ></script>
