...
<script language="JavaScript" src="<@s.url value="/" />html/js/ad/adAddTmgManyURL.js?t=20180802001"></script>
...
<div id="loadingWaitBlock">
	...
	<div class="queryResult" id="tableList" style="display:none;">
		...
		<table id="tableView" class="tableManager" width="100%" border="0" cellpadding="0" cellspacing="1" role="grid">
			<thead>
				<tr role="row">
					<th width="35" data-column="0" scope="col" role="columnheader" aria-disabled="true" unselectable="on" aria-sort="none" aria-label="全選: No sort applied, sorting is disabled" style="user-select: none;">
