	        	...
	        	<tbody>
	        		<tr id="searchTr">
	                    ...
	                    <td>
							...
							<input type="radio" id="adGroupSearchPriceType" name="adGroupSearchPriceType" value="2" <#if adGroupSearchPriceType == "2">checked</#if>><b>自行設定分類出價金額NT$<input type="text" style="width:50px" id="adGroupSearchPrice" name="adGroupSearchPrice" value="${defSearchPrice!}" maxlength="6"></b><div id="searchPricEerrorMsg" style="color:red;margin-left:10px;display:inline;"></div><br/>
