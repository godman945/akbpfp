	        	...
	        	<tbody>
	                ...
	                <tr id="channelTr">
	                    ...
	                    <td>
	                    	...
	                    	<br>
		                    	<b>系統建議出價NT$<input type="number" min="0" step="0.1" id="adPrice" name="adPrice" style="width:50px" maxlength="6" value="${sysprice!}">，系統預估播出率:<span id="showRate" name="showRate">${AdAsideRate!}%</b><div id="errorMsg" style="color:red;margin-left:10px;display:inline;"></div></span>
