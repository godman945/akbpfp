<#assign s=JspTaglibs["/struts-tags"]>
	...
	<script language="JavaScript" src="<@s.url value="/" />html/js/jquery/jquery.validate.js"></script>
	...
	<script language="JavaScript" src="<@s.url value="/" />html/js/catalogProd/prodGroup/ec/ec.copy.prod.group.filter.prod.list.view.js?t=20180917001"></script>
	
	
	<!--
	<script language="JavaScript" src="<@s.url value="/" />html/js/jquery/jquery-1.12.4.js"></script>
	<script language="JavaScript" src="<@s.url value="/" />html/js/jquery/jquery-ui-1.12.1.js"></script>
	-->
