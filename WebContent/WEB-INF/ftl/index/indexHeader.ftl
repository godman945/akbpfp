...
<div class="videobg">
	...
	<div class="photobg show-in-mobile" style="opacity: 0.092;"><img src="img/videobg.jpg"></div>
</div>

<div id="title" class="title text-center" style="opacity: -2.02667;">
	<table>
		<tbody><tr><td>
		<img src="img/pchomelogo.png" alt="" class="titlogo">
		<h1>聯播網廣告</h1>
...
<div class="contentbox">
	...
	<div id="step" class="container-fluid text-center steps">
		...
		<div class="row stepbox">
			<div class="col-sm-4">
				...
				<div class="stepicon"><img src="img/stepicon1.png"></div>
				<h3>建立聯播網廣告</h3>
			...
			<div class="col-sm-4">
				<span class="glyphicon glyphicon-menu-right"></span>
				<div class="stepicon"><img src="img/stepicon2.png"></div>
				<h3>選擇廣告形式</h3>
				<h5>可選擇搜尋廣告與聯播網廣告兩種廣告形式。</h5>
				<span class="glyphicon glyphicon-menu-down"></span>
			</div>
			<div class="col-sm-4">
				<div class="stepicon"><img src="img/stepicon3.png"></div>
	...
	<div id="impression" class="container-fluid text-center impression">
		...
		<div class="row row1">
			<div class="col-sm-12"><img src="img/imp-img1.png"></div>
			<div class="col-sm-12"><img src="img/imp-img2.png"></div>
		</div>
		<br>
		<br>
		...
		<div class="row row2" style="max-width:1020px;margin:auto">
			<div class="col-sm-6 col-sx-12">
				...
				<img src="img/imp-img3.png">
			</div>
			<div class="col-sm-6 col-sx-12">
				<p class="rht">您的關鍵字廣告將在此曝光!</p>
				<img src="img/imp-img4.png"></div>
		</div>
		<br>
		<br>
		...
		<div class="row row3" style="max-width:1100px;margin:auto">
			<div class="col-sm-12">
				<img src="img/L-managertoday.png">
				<img src="img/L-teepr.png">
				<img src="img/L-igamer.png">
				<img src="img/L-bnext.png">
				<img src="img/L-mamaclub.png">
				<img src="img/L-juksy.png">

				<img src="img/L-nownews.png">
				<img src="img/L-123kubo.png">
				<img src="img/L-dodocook.png">
				<img src="img/L-youthwant.png">
				<img src="img/L-roodo.png">
				<img src="img/L-eznewlife.png">
				
				<img src="img/L-5678news.png">
				<img src="img/L-PTT.png">
				<img src="img/L-weatherrisk.png">
				<img src="img/L-iguang.png">
				<img src="img/L-ck101.png">
				<img src="img/L-ithome.png">
				
				<img src="img/L-jkf.png">
				<img src="img/L-moneydj.png">
				<img src="img/L-cool3c.png">
				<img src="img/L-healthnews.png">
				<img src="img/L-ytower.png">
				<img src="img/L-plurk.png">
			</div>
			<span>More...
		</span></div>
	</div>
	...
	<div id="advantage" class="container-fluid advantage">
		...
		<a class="buybtn" href="#">立即購買<span class="glyphicon glyphicon-menu-right"></span>聯播網廣告</a>
	</div>
