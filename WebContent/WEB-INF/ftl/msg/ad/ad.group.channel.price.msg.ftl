...
<div id="channelPrice" class="noticepop" style="width:520px">
	...
	<div class="popcont">
		<em>»</em>聯播廣告出價設定<em>›</em><b>分類：${adGroup.adGroupName!}</b><br/>	
		<p style="border:0;border-top:1px dashed #ccc;margin-top:5px;">
 			出價金額會決定廣告播出率。系統會依每次廣告的競價結果分析出最佳的播出率，實際支付的廣告點擊費用，會小於或等於您的出價金額。
		</p><br/>
		<b>要獲得廣告較高的播出率，聯播廣告預設出價請輸入NT$${sysprice!}</b><br/>
			NT$&nbsp;<input type="text" id="userPrice" name="userPrice" style="width:100px;" maxlength="6" value="${userprice!}">
