...
<form id="excerptFrom" name="excerptFrom" action="reportAdAgesexDownload.html" method="post">
	...
	<input type="hidden" id="fadSearchAgesex" name="searchAgesex" value="${searchAgesex}">
