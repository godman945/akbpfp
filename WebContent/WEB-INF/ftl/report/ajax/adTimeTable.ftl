...
<form id="excerptFrom" name="excerptFrom" action="reportAdTimeDownload.html" method="post">
	...
	<input type="hidden" id="fadSearchTime" name="searchTime" value="${searchTime}">
