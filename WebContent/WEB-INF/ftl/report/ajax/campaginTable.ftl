...
<table id="excerptTable" width="100%" border="0" cellpadding="0" cellspacing="1" class="tablesorter" > 
     ...
     <#list tableDataList as td>
		 ...
		 <tr height="30">
		<#list td as tdin>
			<#if index = 6 || index = 10 || index = 11 || index = 12 || index = 14 || index = 16>
				<td align="${align_data[index]}">NT$ ${tdin}</td>	
			<#elseif index = 9 || index = 15 || index = 17>
 	...
 	<tr height="35">
	    <#assign index2 = 0>
   		<#list tableDataTotalList as th>
			...
			<#elseif index2 = 9 || index2 = 15 || index2 = 17>
...
<form id="excerptFrom" name="excerptFrom" action="reportCampaginDownload.html" method="post">
