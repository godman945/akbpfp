  ...
  <tr> 
	    ...
	    <td>
	    	<select name="adtype" id="adType"> 
	      		<option selected="selected" value="adtype_activity">廣告活動</option> 
	      		<option value="adtype_group">主題群組</option> 
	      		<option value="adtype_keyword">關鍵字</option> 
	        </select>
	    </td> 
...
<form id="excerptFrom" name="excerptFrom" action="reportCheckDownload.html" method="post">
