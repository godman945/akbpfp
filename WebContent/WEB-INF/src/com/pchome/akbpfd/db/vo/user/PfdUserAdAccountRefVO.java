package com.pchome.akbpfd.db.vo.user;



public class PfdUserAdAccountRefVO {
	...
	public String getPfpUserId() {
		return pfpUserId;
	}
	public void setPfpUserId(String pfpUserId) {
		this.pfpUserId = pfpUserId;
	}
