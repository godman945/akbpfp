...
//	}
	...
	public PfpAdGroup getPfpAdGroupBySeq(String adGroupSeq) throws Exception {
		...
		List<PfpAdGroup> list = super.getHibernateTemplate().find("from PfpAdGroup where adGroupSeq = ?", obj);
		if (list!=null && list.size()>0) {
			return list.get(0);
		} else {
			return null;
...
//		}
	...
	public List<PfpAdGroup> validAdGroup(String adActionSeq) throws Exception{
		...
		return super.getHibernateTemplate().find(hql.toString(),adActionSeq,EnumStatus.Close.getStatusId());
	}
	...
	public List<PfpAdGroup> getAdGroups(String adActionSeq, String orderBy, boolean desc) throws Exception{
		...
		return super.getHibernateTemplate().find(hql.toString(),adActionSeq);
	}
}
