...
//						log.info(">>> dataList.size() = " + dataList.size());
	...
	private HashMap<String, Object> getAdGroupReportCountStr(String adActionSeq, String searchText, String adSearchWay, String adShowWay, String adPvclkDevice,
		...
		hql.append(" sum((case when r.ad_clk_price_type = 'CPC' then r.ad_clk when r.ad_clk_price_type = 'CPM' then r.ad_clk else r.ad_view end)), ");				// 產生pfp_ad_group_report 的時候，已經減過無效點擊數了，所以不用再減
