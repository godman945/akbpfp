 ...
 */
@Entity
@Table(name = "pfd_ad_template_report", catalog = "akb_video")
public class PfdAdTemplateReport implements java.io.Serializable {
	...
	public PfdAdTemplateReport(Date adPvclkDate, String templateProductSeq, String adClkPriceType, int adPv, int adVpv,
