 ...
 */
@Entity
@Table(name = "pfd_apply_for_business", catalog = "akb_video")
public class PfdApplyForBusiness implements java.io.Serializable {
	...
	public PfdApplyForBusiness(String pfdCustomerInfoId, String pfdUserId, String targetTaxId, String targetAdUrl,
			String status, Date applyForTime) {
	...
	public PfdApplyForBusiness(String pfdCustomerInfoId, String pfdUserId, String targetTaxId, String targetAdUrl,
			String status, Date applyForTime, Date checkTime, Date sysPassTime, String checkUser, String rejectReason,
