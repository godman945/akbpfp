 ...
 */
@Entity
@Table(name = "pfd_board", catalog = "akb")
public class PfdBoard implements java.io.Serializable {
	...
	public PfdBoard(String boardContent, String boardType, String isSysBoard,
			Date startDate, Date endDate, String hasUrl, Date createDate) {
	...
	public PfdBoard(String pfdCustomerInfoId, String pfdUserId,
			String boardContent, String boardType, String isSysBoard,
			Date startDate, Date endDate, String hasUrl, String urlAddress,
			String deleteId, String msgPrivilege, Date updateDate,
			Date createDate) {
