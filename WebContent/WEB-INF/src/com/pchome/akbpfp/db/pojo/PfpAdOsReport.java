 ...
 */
@Entity
@Table(name = "pfp_ad_os_report", catalog = "akb")
public class PfpAdOsReport implements java.io.Serializable {
	...
	public PfpAdOsReport(Date adPvclkDate, String adPvclkDevice,
			String customerInfoId, String adSeq, String adGroupSeq,
			String adActionSeq, String templateProductSeq, int adPv, int adClk,
	...
	public PfpAdOsReport(Date adPvclkDate, String adPvclkDevice,
			String adPvclkOs, String customerInfoId, String adSeq,
			String adGroupSeq, String adActionSeq, String templateProductSeq,
