 ...
 */
@Entity
@Table(name = "pfp_sysprice_rate", catalog = "akb_video")
public class PfpSyspriceRate implements java.io.Serializable {
	...
	public PfpSyspriceRate(String adPoolSeq, float kernelPrice, int syspriceRatePv, int syspriceRateClk,
			Date syspriceRateDate, int syspriceRateTime, Date syspriceRateCreateTime, Date syspriceRateUpdateTime) {
	...
	@Column(name = "sysprice_rate_date", nullable = false, length = 0)
	...
	@Column(name = "sysprice_rate_create_time", nullable = false, length = 0)
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "sysprice_rate_update_time", nullable = false, length = 0)
