...
public class BillPrivilegeInterceptor extends AbstractInterceptor{
	...
	public String intercept(ActionInvocation invocation) throws Exception{
		...
		// 只有 root or adm or ad or report or bill 權限才能進入
		if(EnumPrivilegeModel.ROOT_USER.getPrivilegeId() == privilegeId ||
				...
				EnumPrivilegeModel.REPORT_USER.getPrivilegeId() == privilegeId ||
				EnumPrivilegeModel.BILL_USER.getPrivilegeId() == privilegeId){
