...
//			String path = "/export/home/webuser/akb/pfp/img/user/AC2013071700005/20180926/original/ad_201809260001/logo_300_55_03-300x55.jpeg";
////							
...
//			ImageIO.write(bi, a[a.length-1], baos);
//			byte[] bytes = baos.toByteArray();
//			String n = new Base64().encodeToString(bytes);
//			System.out.println(n.replaceAll( "\\s",""));
//			System.out.println("data:image/"+a[a.length-1]+";base64,"+Base64Encoder.encode(bytes).toString());
