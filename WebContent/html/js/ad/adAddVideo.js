	...
	$.each(iframeInfoMap, function(key, obj) {
			var a = 
				'<div class="v_box">'+
				   ...
				   'src="adVideoPreview.html?adPreviewVideoURL='+encodeURIComponent(url)+'&picPath='+obj.picPath+'"></iframe>';
				   '</div>'+
				'</div>';
		...
		if(radioObj.checked){
			...
			if(!createPreViewVideoExist){
				...
				'<div class="v_box">'+
				   ...
				   'src="adVideoPreview.html?adPreviewVideoURL='+encodeURIComponent(url)+'&picPath='+imgSrc+'"></iframe>';
				   '</div>'+
				'</div>';
				$("#preViewArea").append(a);
