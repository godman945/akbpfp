...
var highChartActionPath="reportAdDailyAjaxChart.html";
var reportAjaxActionPath="reportAdDailyAjaxTable.html";
...
function ready(){
	if($("#excerptTable").children().length > 1){
		...
		$($($("#excerptTable").children()[0]).children()[0]).children()[4].append(node)
	}
