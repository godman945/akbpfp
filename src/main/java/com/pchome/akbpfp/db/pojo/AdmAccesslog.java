...
public class AdmAccesslog  implements java.io.Serializable {
    ...
    public AdmAccesslog(String channel, String action, String message, String memberId, String orderId, String customerInfoId, String userId, String clientIp, String mailSend, Date createDate) {
       this.channel = channel;
       this.action = action;
       this.message = message;
