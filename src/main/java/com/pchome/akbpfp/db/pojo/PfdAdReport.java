...
public class PfdAdReport implements java.io.Serializable {
	...
	public PfdAdReport(Date adPvclkDate, String pfpCustomerInfoId, String adSeq, String adGroupSeq, String adActionSeq,
			String templateProductSeq, int adType, String adOperatingRule, String adClkPriceType, int adPv, int adVpv,
			int adClk, int adView, int adInvalidClk, float adClkPrice, float adInvalidClkPrice, int convertCount,
			int convertPriceCount, Date createDate, Date updateDate) {
	...
	public PfdAdReport(Date adPvclkDate, String adPvclkDevice, String pfdCustomerInfoId, String pfdUserId,
			String pfpCustomerInfoId, String adSeq, String adGroupSeq, String adActionSeq, String templateProductSeq,
			int adType, String adOperatingRule, String adClkPriceType, int adPv, int adVpv, int adClk, int adView,
			int adInvalidClk, float adClkPrice, float adInvalidClkPrice, int convertCount, int convertPriceCount,
