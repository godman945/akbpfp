...
public class PfdAdTemplateReport implements java.io.Serializable {
	...
	public PfdAdTemplateReport(Date adPvclkDate, String templateProductSeq, String adOperatingRule,
			...
			float adInvalidClkPrice, int convertCount, int convertPriceCount, Date createDate, Date updateDate) {
	...
	public PfdAdTemplateReport(Date adPvclkDate, String pfdCustomerInfoId, String templateProductSeq,
			...
			float adClkPrice, float adInvalidClkPrice, int convertCount, int convertPriceCount, Date createDate,
			Date updateDate) {
		this.adPvclkDate = adPvclkDate;
