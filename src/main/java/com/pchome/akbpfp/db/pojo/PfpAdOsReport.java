...
/**
 * PfpAdOsReport generated by hbm2java
 */
@Entity
@Table(name = "pfp_ad_os_report")
public class PfpAdOsReport implements java.io.Serializable {

	private Integer adOsReportSeq;
	...
	public PfpAdOsReport(Date adPvclkDate, String adPvclkDevice, String customerInfoId, String adClkPriceType, int adPv,
			int adVpv, int adClk, int adView, int adInvalidClk, float adClkPrice, float adInvalidClkPrice,
			Date createDate, Date updateDate, String adSeq, String adGroupSeq, String adActionSeq,
			String templateProductSeq, int convertCount, int convertPriceCount) {
	...
	public PfpAdOsReport(Date adPvclkDate, String adPvclkDevice, String adPvclkOs, String customerInfoId,
			...
			String adActionSeq, String templateProductSeq, int convertCount, int convertPriceCount) {
		this.adPvclkDate = adPvclkDate;
		this.adPvclkDevice = adPvclkDevice;
	...
	@Column(name = "ad_os_report_seq", unique = true, nullable = false)
	public Integer getAdOsReportSeq() {
		return this.adOsReportSeq;
	}

	public void setAdOsReportSeq(Integer adOsReportSeq) {
		this.adOsReportSeq = adOsReportSeq;
	}
