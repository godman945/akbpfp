...
/**
 * PfpAdWebsiteReport generated by hbm2java
 */
@Entity
@Table(name = "pfp_ad_website_report")
public class PfpAdWebsiteReport implements java.io.Serializable {
