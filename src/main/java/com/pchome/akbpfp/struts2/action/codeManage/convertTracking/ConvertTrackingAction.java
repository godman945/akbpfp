...
public class ConvertTrackingAction  extends BaseCookieAction{
	...
	public String addConvertTrackingView(){		
		try{
			...
			if (pfpCode == null){
				...
				String apiStr = paadmServer + memberId;
	...
	public String getPaadmServer() {
		return paadmServer;
	}

	public void setPaadmServer(String paadmServer) {
		this.paadmServer = paadmServer;
	}
