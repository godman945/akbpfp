...
public class ReportAdvertiseAction extends BaseReportAction {
	...
	private List<AdvertiseReportVO> resultData = new ArrayList<>(); // 查詢結果
	private List<AdvertiseReportVO> resultSumData = new ArrayList<>(); // 查詢結果加總
	...
	private void makeDownloadReportData() throws Exception {
		...
		content.append("狀態,廣告名稱,廣告內容,影片長度,顯示連結,實際連結,廣告活動,廣告分類,");
		...
		if (!resultData.isEmpty()) {
			...
			for (int i = 0; i < resultData.size(); i++) {
				...
				content.append("\"" + resultData.get(i).getAdName() + "\",");
				content.append("\"" + resultData.get(i).getContent() + "\",");
				String videoSec = StringUtils.isBlank(resultData.get(i).getVideoSec()) ? "" : "00:" + resultData.get(i).getVideoSec();
				content.append("\"" + videoSec + "\",");
				content.append("\"" + resultData.get(i).getShowUrl() + "\",");
				content.append("\"" + resultData.get(i).getRealUrl() + "\",");
	...
	public String flashDataDownLoad() {
		...
		for (int i = 0; i < resultChartData.size(); i++) {
			AdvertiseReportVO vo = resultChartData.get(i);
	...
	public List<AdvertiseReportVO> getResultData() {
		return resultData;
	}

	public List<AdvertiseReportVO> getResultSumData() {
...
//				convertInvestmentCost = (convertPriceCount / Double.valueOf(adReportVO.getAdPriceSum())) * 100;
//			}
...
//					content.append(adReportVO.getContent()+",");
//					content.append(",");
//					String showUrl = StringUtils.isBlank(adReportVO.getShowUrl()) ? "" : adReportVO.getShowUrl();
//					content.append(showUrl+",");
//				}
//				System.out.println(sumPV);
//				System.out.println(adReportVO.getRealUrl());
...
//			content.append("\"NT$ "+df.format(singleCost)+"\",");
//			content.append("NT$ "+df.format(thousandsCost)+",");
//			content.append("\"NT$ "+df.format(Double.parseDouble(adReportVO.getAdPriceSum()))+"\"");
//			if(hasPfpCodeflag){
//				content.append(",");
//				content.append(adReportVO.getConvertCount()+",");
//				content.append("\"NT$ "+ adReportVO.getConvertPriceCount()+"\",");
//				content.append("\""+convertCTR+"%\",");
//				content.append("\"NT$ "+ convertCost+"\",");
...
//			t_convert_investment_cost = (t_convert_price_count / totalCost) * 100;
//		}
//		
//		
//		//總計
...
//					+ "\""+df.format((sumClick/sumPV)*100)+"%\","
//					+ (totalCost / sumClick)+","
//					+ "\"NT$"+totalCost / (sumPV / 1000)+"\","
//					+ "=\"NT$"+totalCost+"\"");
//			
//			if(hasPfpCodeflag){
//				content.append(",");
//				content.append(t_convert_count+",");
//				content.append("\"NT$"+t_convert_price_count+"\",");
//				content.append("\""+df.format(t_convert_ctr)+"%\",");
//				content.append("\"NT$"+t_convert_cost+"\",");
