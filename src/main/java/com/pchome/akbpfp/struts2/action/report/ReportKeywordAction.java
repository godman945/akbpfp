...
public class ReportKeywordAction extends BaseReportAction {
	...
	private Map<String, List<AdKeywordReportVO>> testMap = new LinkedHashMap<>(); // 測試用
//	private Map<String, List<AdKeywordReportVO>> resultData = new LinkedHashMap<>(); // 查詢結果
	...
	public String execute() throws Exception {
		...
		// 測試用
		List<AdKeywordReportVO> subtotalList = new ArrayList<>();
		subtotalList.add(vo);
		
		List<AdKeywordReportVO> detailList = new ArrayList<>();
		detailList.add(vo);
		detailList.add(vo);
		testMap.put("subtotalList", subtotalList); // 小計列
		testMap.put("detailList", detailList); // 明細列
	...
	public Map<String, List<AdKeywordReportVO>> getTestMap() {
		return testMap;
	}
...
//	public Map<String, List<AdKeywordReportVO>> getResultData() {
//		return resultData;
//	}
