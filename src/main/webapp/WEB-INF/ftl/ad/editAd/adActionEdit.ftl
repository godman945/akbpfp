...
<div class="cont">
		        ...
		        <table width="100%" cellspacing="1" cellpadding="0" border="0" class="tb02">
		        	<tbody>
		        		<tr>
	                        ...
	                        <td>
	                        	<input type="radio" value="N" name="convertCodeRadio" checked>不使用轉換追蹤
	                        	<br/>
	                        	<input type="radio" value="Y" name="convertCodeRadio"  >使用轉換追蹤，套用代碼：
	                        	<select id="convertCodeSelect" name=""> 
	...
	<textarea  id="prodCodeInfo" style="display:none;" name="prodCodeInfo"/>${prodCodeInfo!}</textarea>
	<input type="hidden" id="adCountry" name="adCountry" value="${adCountry!}">
    </form>
</div>
...
​<textarea id="txtArea3" rows="10" cols="70" style="display:none">
	${adCountryMapJson!}
</textarea>