...
<#assign t=JspTaglibs["http://tiles.apache.org/tags-tiles"]>
	...
	<script language="JavaScript" src="<@s.url value="/" />html/js/<@t.getAsString name="dateJsName" />" ></script>
	<script language="JavaScript" src="<@s.url value="/" />html/js/<@t.getAsString name="validateJs" />" ></script>
