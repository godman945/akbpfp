...
<div class="cont">
		...
		<ul class="admenuul">
            <li class="m01"><a href="adAddImg.html?adGroupSeq=${adGroupSeq!}&adOperatingRule=MEDIA" class="active" class="active" onClick="return(chkLeave())">圖像廣告</a></li>
            <li class="m02"><a href="adAdAdd.html?adGroupSeq=${adGroupSeq!}&adOperatingRule=MEDIA" onClick="return(chkLeave())">圖文廣告</a></li>
