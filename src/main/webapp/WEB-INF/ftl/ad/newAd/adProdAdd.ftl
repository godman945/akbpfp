	...
	<@t.insertAttribute name="head" />
    	<div class="grtba">
			...
			<table width="100%" cellspacing="1" cellpadding="0" border="0" class="tb02 newtb"><tbody>
				<tr>
					<th><span class="t_s02">* </span>商品廣告名稱</th>
					<td colspan="2">
				...
				<tr>
					<th><span class="t_s02">* </span>選擇商品目錄</th>
					<td colspan="2">
				...
				<tr>
					<th><span class="t_s02">* </span>選擇商品組合</th>
					<td colspan="2">
						<div class="inputselect">
								...
								<#if catalogList?exists>
									<#list catalogList as pfpCatalog>
										<#if pfpCatalog.pfpCatalogGroups?exists>
											<#list pfpCatalog.pfpCatalogGroups?sort_by("catalogGroupSeq") as pfpCatalogGroup>
				...
				<tr>
					<th><span class="t_s02">* </span>連結網址</th>
					<td colspan="2">
				...
				<tr>
					<th><span class="t_s02">* </span>品牌LOGO</th>
					<td>
				...
				<tr>
					<th><span class="t_s02">* </span>按鈕</th>
					<td>
						<ul class="newtbsublist">
							<li>
