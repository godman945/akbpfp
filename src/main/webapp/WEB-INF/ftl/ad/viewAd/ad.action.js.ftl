...
<#assign t=JspTaglibs["http://tiles.apache.org/tags-tiles"]>
	...
	<script language="JavaScript" src="<@s.url value="/" />html/js/ad/ad.common.js" />"></script>
	<script language="JavaScript" src="<@s.url value="/" />html/js/ad/<@t.getAsString name="jsMsg" />"></script>
	<script language="JavaScript" src="<@s.url value="/" />html/js/ad/<@t.getAsString name="jsName" />" ></script>