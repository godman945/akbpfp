<#assign s=JspTaglibs["/struts-tags"]>
	...
	<script language="JavaScript" src="<@s.url value="/" />html/js/jquery/jquery.tablescroll.js"></script>
	<script language="JavaScript" src="<@s.url value="/" />html/js/bill/transDetail.js"></script>
