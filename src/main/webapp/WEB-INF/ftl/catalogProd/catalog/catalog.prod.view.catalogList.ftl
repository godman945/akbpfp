...
<script language="JavaScript" src="<@s.url value="/" />html/js/catalogProd/catalog/catalog.js?t=20181228001"></script>
            ...
            <ul class="txt-table">
                ...
                <li class="txt-cell pos-relative p-r10">
                    <span class="icon-box tab-logomanage p-r10">
                        <a href="logo.html">LOGO管理<#if showPromptMessage == true><em class="icon-error"></em></#if></a>                                                        
                    </span>
                </li> 
