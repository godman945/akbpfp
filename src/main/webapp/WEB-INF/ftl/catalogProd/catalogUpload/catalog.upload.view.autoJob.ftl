...
<script language="JavaScript" src="<@s.url value="/" />html/js/catalogProd/catalogUpload/autoJob.js?t=20190215001"></script>
	...
	<div id="loadingWaitBlock">
	    ...
	    <div class="content-wrap bg-white">
	        ...
	        <div class="button-box w-900 txt-center p-tb60">
	            ...
	            <div class="input-button"><input type="button" onclick="autoJobFinish();" value="送出審核"></div>
	        </div>
