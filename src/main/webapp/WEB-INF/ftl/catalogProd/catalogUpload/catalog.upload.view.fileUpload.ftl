...
<script language="JavaScript" src="<@s.url value="/" />html/js/catalogProd/catalogUpload/fileUpload.js?t=20190215001"></script>
		                    ...
		                    <div class="scvupload-box select">
		                        ...
		                        <div class="txt-table failure">
		                            <div class="txt-cell">
		                                ...
		                                <u id="errorMsg">檔案格式錯誤</u><br><small>重新上傳檔案，請將檔案拖放到這裡，或<a href="javascript:void(0);" onclick="fileUpload();">選擇要上傳的檔案</a></small>
		                            </div>
		                        </div>
