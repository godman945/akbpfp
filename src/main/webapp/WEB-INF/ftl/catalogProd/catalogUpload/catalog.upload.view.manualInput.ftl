...
<script language="JavaScript" src="<@s.url value="/" />html/js/catalogProd/catalogUpload/manualInput.js?t=20181228001"></script>
	                ...
	                <div class="manualadd-box">
	                    ...
	                    <div class="txt-cell manual-inputbox">
	                        <div class="manual-item">
	                            <i class="input-tit"><span class="t_s02">*</span>商品名稱</i>
	                        ...
	                        <div class="manual-item">
	                            <i class="input-tit"><span class="t_s02">*</span>商品網址</i>
	                            <div class="input-text">
	                        ...
	                        <div class="manual-item">
	                            <i class="input-tit"><span class="t_s02">*</span>特價</i>
	                            <div class="input-number">
	                            	<#-- onkeypress 只能輸入數字-->
	                        ...
	                        <div class="manual-item">
	                            <i class="input-tit"><span class="t_s02">*</span>供應情況</i>
	                            <div class="select-box">
	                        ...
	                        <div class="manual-item">
	                            <i class="input-tit"><span class="t_s02">*</span>使用狀況</i>
	                            <div class="select-box">
	                        ...
	                        <div class="manual-item">                            
	                            <i class="input-tit"><span class="t_s02">*</span>商品編號</i>                            
	                            <div class="input-text no-invalid">                               
	                               <input type="text" id="catalogProdSeq" name="catalogProdSeq" maxlength="20" value="" required="" placeholder="限20字內">
	                        ...
	                        <div class="manual-item">                            
	                            ...
	                            <div class="input-text no-invalid">                               
	                               <input type="text" id="ecCategory" name="ecCategory" maxlength="20" value="" placeholder="限20字內">
