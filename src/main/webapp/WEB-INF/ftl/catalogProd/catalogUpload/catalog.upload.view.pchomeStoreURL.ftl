...
<script language="JavaScript" src="<@s.url value="/" />html/js/catalogProd/catalogUpload/pchomeStoreURL.js?t=20190131001"></script>
	    ...
	    <div class="content-wrap bg-white">
	        <div class="content-box bg-white w-900">
	            ...
	            <div class="section-box">
	                ...
	                <span class="txt-descript">使用 PChome商店街、PChome商店街 個人賣場、露天拍賣的賣場網址上傳商品資訊，系統每日AM 1:00自動執行更新一次，請至商品清單查看每日更新結果。</span>
