...
<script language="JavaScript" src="<@s.url value="/" />html/js/catalogProd/catalogUpload/catalogUpload.js?t=20190214001"></script>
		        ...
		        <div class="content-box bg-white w-900">
		            ...
		            <div id="dataupload" class="section-box">
		                ...
		                <div class="dataupload-wrap txt-noselect">
		                    <div class="dataupload-box selected" item="1">
		                ...
		                <div class="dataupload-wrap txt-noselect">
		                    <div class="dataupload-box" item="2">
		                        <div class="svg-box medium">
		                ...
		                <#-- 暫不開放
		                <div class="dataupload-wrap txt-noselect">
		                    <div class="dataupload-box" item="3">
		                        <div class="svg-box medium">
		                            <object class="svg-img" data="<@s.url value="/" />html/img/catalogProd/catalogUpload/dataupload-url.svg" type="image/svg+xml"></object>
		                        </div>
		                        <p>PChome賣場網址上傳<span>使用 PChome商店街、PChome商店街 個人賣場、露天拍賣的賣場網址上傳商品資訊，系統每日AM 1:00自動執行更新一次，請至商品清單查看每日更新結果。</span></p>
		                    </div>
		                </div>
		                -->

		                <div class="dataupload-wrap txt-noselect">
		                    <div class="dataupload-box" item="4">
		                        <div class="svg-box medium">
