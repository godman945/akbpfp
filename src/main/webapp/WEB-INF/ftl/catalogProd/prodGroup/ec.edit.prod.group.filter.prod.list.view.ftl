			                                ...
			                                <#elseif filterItem.catalogGroupItemField == 'ec_category' >
			                                    ...
			                                    <div class="txt-inlineblock level3">
				                                        <div class="input-text" data-level="1" >
				                                            <input type="text" name="" maxlength="20" value="${filterItem.catalogGroupItemValue!}">
				                                        ...
				                                        <div class="select-box" data-level="4">
				                                            ...
				                                            <input class="tags" type="text" name="" maxlength="20" value="${filterItem.catalogGroupItemValue!}">
