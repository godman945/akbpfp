	                        			...
	                        			<div class="content-box bg-white w-900">
							    				...
							    				<div class="txt-row">
										   		<div class="txt-cell col-protfolioname">
										        	<em class="icon-arrow-r"></em>全部商品
										        	<small>(${dataVo.catalogGroupSeq!})</small>
										        </div>
	                        		...
	                        		<#else>
				                        <div class="portfolio-item" onclick="$(this).toggleClass('opened')">
				                            <div class="txt-row">
				                                ...
				                                <div class="txt-cell col-edit"><a href="javascript:void(0)" onclick="stopBubble(event);editPortfolio('${catalogSeq}','${dataVo.catalogGroupSeq!}')"></a></div>
