            ...
            <div class="section-box p-b60">
                <p class="title-box h2">選擇轉換類型</p>
                 ...
                 <div class="transselect-group type">
                    ...
                    <div class="inputradio-box txt-noselect">
                        <div class="input-radio">
                            <input type="radio" value="9" id="typeselect9" name="typeselect">
                            <label for="typeselect9"></label>
                            <span>加到願望清單</span>
                        </div>
                    </div>
                ...
                <div class="transselect-group value">
                    ...
                    <div class="inputradio-box txt-noselect">
                        ...
                        <div class="input-number" data-width="130">
                            NT<input id="unifiedConvertPrice" type="text" name="" maxlength="6" value="">
                            <span>元</span>
                    ...
                    <div id="customConvertPriceDiv" class="inputradio-box txt-noselect">
                        ...
                        <div class="input-number" data-width="165">
                            預設NT<input id="customConvertPrice" type="text" name="" maxlength="6" value="">
                            <span>元</span>
            ...
            <div class="section-box p-b60">
               ...
               <!---切換-->
                <div class="code-switch">
                    <div class="codeswitchTag select" onclick="webImpConvertTracking($(this))">
                        <span>網頁曝光追蹤</span></div>
                    <div class="codeswitchTag" onclick="webClickConvertTracking($(this))">
                        <span>點擊事件追蹤</span>
                    </div>
                </div>

                <!--網頁曝光追蹤 start-->
                <div class="code-eventWeb" id="codeEventWeb" style="display:">
...
<script>
   ...
   'convert_price':''});   
                    ...
                    <div class="link-copyto p-t5 txt-right">
                        <a id="copyCode1" class="btn-copyto" data-clipboard-action="copy" data-clipboard-target="#code1"><em>複製代碼</em></a>
                    </div>
                    <div id="copyCodeSuccess1" class="copySuccess txt-center" style="display:none">複製成功</div>                             
                </div>
                <!--網頁曝光追蹤 END-->

                <!--點擊事件追蹤 start-->
                <div class="code-eventClick" id="codeEventClick" style="display:none">
                    <div class="code-wrap pos-relative">
                        <a class="btn-copyto code-copy pos-absolute pos-right pos-top txt-noselect" data-clipboard-action="copy"
                            data-clipboard-target="#code2"></a>
                        <div class="code-box">
                            <pre class="snippet">
...
<script>
   ...
   'convert_price':''},'click');   
                ...
                <div class="link-copyto p-t5 txt-right">
                    <a  id="copyCode2" class="btn-copyto" data-clipboard-action="copy" data-clipboard-target="#code2"><em>複製代碼</em></a>
                </div>
                
                <div id="copyCodeSuccess2" class="copySuccess txt-center" style="display:none;">複製成功</div>
                
                <div class="eventClick-codenote">
			                        將追蹤碼：<span>pchome_click('到達網址',true/false)</span> 套入您網頁上的按鈕或連結 (true：開新頁籤，false：本頁開啟)<br>
			                        範例：<span>< </span>input type="button" value="TEST" onclick="pchome_click('http://www.pchome.com.tw',true);"/>
                </div>
    ...
    <div class="button-box w-900 txt-center p-tb30">
        <div class="input-button"><input id="addConvertTracking" type="button" value="完成"></div>
    </div>
</#if> 
  ...
  <input type="hidden" id="convertSeq" value="${convertSeq!}">
