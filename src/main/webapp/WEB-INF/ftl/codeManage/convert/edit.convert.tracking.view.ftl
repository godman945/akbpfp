...
<#else>
    ...
    <div class="content-wrap bg-white">
        <p class="title-box h1 txt-center">編輯 轉換追蹤代碼</p>
            ...
            <div class="section-box p-b60">
              ...
              <!---切換-->
                <div class="code-switch">
                    <div id="webImpConvertTracking" class="codeswitchTag select" onclick="webImpConvertTracking($(this))">
                        <span>網頁曝光追蹤</span></div>
                    <div id="webClickConvertTracking" class="codeswitchTag" onclick="webClickConvertTracking($(this))">
                        <span>點擊事件追蹤</span>
                    </div>
                </div>
...
<script>
  ...
  <input type="hidden" id="convertCodeType" value="${convertTrackingBean.convertCodeType!}">
