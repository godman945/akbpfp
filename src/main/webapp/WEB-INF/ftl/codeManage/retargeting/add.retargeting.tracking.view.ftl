...
<#else>
        ...
        <div class="content-wrap bg-white">
            <p class="title-box h1 txt-center">建立 再行銷追蹤代碼</p>
...
<script>
   ...
   'tracking_id':'${trackingSeq!}'
                    ...
                    <div id="dynamicAdDescription" class="copyDescription" style="display:none;">
                    	<small>
        ...
        <div class="button-box w-900 txt-center p-tb30">
            <div class="input-button"><input id="addRetargetingTracking" type="button" value="完成"></div>
        </div>
</#if> 
</div>
