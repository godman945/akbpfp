...
<#if retargetingList?exists && (retargetingList?size>0)>
        <!-- 次目錄導覽列 開始 -->
	                        		...
	                        		<#if retargetingList?size != 0>
	                        			...
	                        			<#list retargetingList as retargetings>
				                            ...
				                            <div class="txt-cell col-ptagcheckbox">
				                                ...
				                                <div class="txt-cell col-ptagname    "><a href="editRetargetingTrackingView.html?trackingSeq=${retargetings.trackingSeq!}">${retargetings.trackingName!?replace(" ", "&nbsp;")}</a><br><small>ID：${retargetings.trackingSeq!}</small></div>
				                                ...
				                                <div class="txt-cell col-ptagtype    ">${retargetings.codeTypeDesc!}</div>
				                                <div class="txt-cell col-ptagperiod  ">${retargetings.trackingRangeDate!}天</div>
