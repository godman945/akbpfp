...
<#assign checkDate2 = ("2014-03-26 00:00:00")?date("yyyy-MM-dd HH:mm:ss")> 
	...
	<script type="text/javascript" src="http://rmi.pchome.com.tw/rmiservice/pv.html?t=pfp:pv_pfp_click2"></script>
	...
	<#else>
		<div id="content" style="background:url(<@s.url value="/" />html/main/img/click_20140401_2.png) top center no-repeat;height:900px">
		</div>
	</#if>
	</div>
</div>