...
<#assign t=JspTaglibs["http://tiles.apache.org/tags-tiles"]>
	...
	<script type="text/javascript" src="http://rmi.pchome.com.tw/rmiservice/pv.html?t=pfp:pv_pfp_pay"></script>
	...
	<div id="header">
		<div class="nav" style="display:none;">
			<ul id="topNavi">
				...
				<li><a class="pay selected" href="<@s.url value="/" />pay.html#content"></a></li>
	...
	<div class="container clearfix">
		<div id="content" style="background:url(<@s.url value="/" />html/main/img/cont03.png) top center no-repeat;height:800px">
		</div>
	</div>
</div>