...
<#assign t=JspTaglibs["http://tiles.apache.org/tags-tiles"]>
	...
	<div id="header">
		<div class="nav" style="display:none;">
			<ul id="topNavi">
				...
				<li><a class="qa selected" href="<@s.url value="/" />faq.html" target="_blank"></a></li>	
			</ul>
		</div>
		<div class="cotnav">
			<ul id="gNavi" >
	...
	<div class="container clearfix">
		<div id="content">
			<img src="<@s.url value="/" />html/main/img/cont05.png" usemap="#Map" border="0" style="margin:50px 0 0 0;">
			<map name="Map" id="Map">
				<area shape="rect" coords="835,679,965,726" href="<@s.url value="/" />faq.html" target="_blank"/>
			</map>
		</div>
	</div>
</div>