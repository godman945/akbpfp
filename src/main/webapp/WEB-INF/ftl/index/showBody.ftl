...
<#assign t=JspTaglibs["http://tiles.apache.org/tags-tiles"]>
	...
	<script type="text/javascript" src="http://rmi.pchome.com.tw/rmiservice/pv.html?t=pfp:pv_pfp_show"></script>

	<div id="header">
		<div class="nav" style="display:none;">
			<ul id="topNavi">
				<li><a class="newp" href="<@s.url value="/" />index.html#content"></a></li>
				<li><a class="show selected" href="<@s.url value="/" />show.html#content"></a></li>
	...
	<div class="container clearfix">
		<div id="content" style="background:url(<@s.url value="/" />html/main/img/cont02.png) top center no-repeat;height:1350px">
		</div>
	</div>
</div>