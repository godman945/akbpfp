						...
						<tr class="txt-row header">
                            ...
                            <th data-info-name="" class="col-w120">
                                <div class="sortbx-selectTH pos-relative txt-left">
                                    <#if viewType == "age">
	                                    <span class="sort-tit pos-relative">年齡</span>
	                                    <ul class="sort-item pos-absolute pos-left">
	                                        <li data-select="" data-sort="ageCode-DESC">從大到小</li>
	                                        <li data-select="" data-sort="ageCode-ASC">從小到大</li>
	                                    </ul>
                                    <#else>
	                                    <span class="sort-tit pos-relative">性別</span>
	                                    <ul class="sort-item pos-absolute pos-left">
	                                        <li data-select="true" data-where="sexCode-all">全部</li>
                                            <li data-select="" data-where="sexCode-M">男性</li>
                                            <li data-select="" data-where="sexCode-F">女性</li>
	                                    </ul>
	                                </#if>
                                </div>
                            </th>
