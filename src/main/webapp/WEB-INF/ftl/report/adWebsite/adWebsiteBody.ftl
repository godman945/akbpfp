...
<div class="container-prodmanage">
	...
	<div class="nav-wrap pos-relative no-pseudo h-auto">
		<div class="nav-title"><p>網站類型成效</p></div>
	</div>
	<!-- 次目錄導覽列 結束 -->
		...
		<div class="content-box p-none">
            ...
            <form id="excerptFrom" name="excerptFrom" action="" method="post">
					...
					<div class="nav-box pos-relative" >
						...
						<ul class="txt-table txt-regular">
							<li class="txt-cell select-menu p-r10" style="display:inline-block;">
                                <div class="select-box dayparts-box pos-relative">
                                    <p class="pos-absolute pointer-events-none ">網站類型</p>
                                    <div class="menu-box" onclick="$('.dayParts').toggle()"></div>
                                    <ul class="date-dropdown dayParts txt-left pos-absolute pos-left w-130" style="display:none">
                                    	<li data-select="true" data-where="websiteCategoryCode-all">全部</li>
	                                    <#list reportWebsiteCategoryMap?keys as skey>
	                                    	<li data-select="" data-where="websiteCategoryCode-${skey}">${reportWebsiteCategoryMap[skey]}</li>
								  	    </#list>
                                    </ul>
                                </div>
                            </li>
	            ...
	            <div class="prodtable-wrap m-b30" data-filter="all">
	            	<@t.insertAttribute name="adWebsiteDetailList" />
	            </div>
	            <!-- 表格內容 結束 -->
