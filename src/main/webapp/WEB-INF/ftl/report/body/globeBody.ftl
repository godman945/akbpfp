...
<div class="scrollwrap">
    ...
    <div class="btn_dlex">
        ...
        <div class="cala01" style="margin-top:20px;">
        	<input id="IT_dateRange" />
        	<img src="http://show.pchome.com.tw/html/img/icon_cal.gif" border="0" align="absmiddle" id="seDateSelect"/>
		</div>
    </div>
	...
	<div class="grtba">
		<div id="reportTableOut" class="scrollwrap">
			<div id="reportTable">
