			...
			<table class="table" data-fixed-columns="2" cellpadding="0" cellspacing="0">
				<thead class="header">                                        
					<tr class="txt-row header">
                        ...
                        <th data-info-name="adDate" class="col-w120">走期</th>
                        ...
                        <th data-info-name="adActionMaxPriceAvg" class="col-w120">
                            <div class="sortbx-selectTH pos-relative txt-right">
                                <span class="sort-tit pos-relative">每日預算</span>
                                <ul class="sort-item pos-absolute pos-right">
                                    <li data-select="" data-sort="adActionMaxPriceAvg-DESC">從大到小</li>
                                    <li data-select="" data-sort="adActionMaxPriceAvg-ASC">從小到大</li>
                                </ul>
                            </div>                        
                        </th>
					...
					<#if (resultData?size > 0) >
						...
						<#list resultData as row>
							<tr class="txt-row detailRow">
                                ...
                                <td data-info-name="adDate">${row.adActionStartDate!}<br>~${row.adActionEndDate!}</td>
								<td data-info-name="">${row.adDevice!}</td>
								<td data-info-name="adActionMaxPriceAvg" class="txt-right"><span class="cost-dollarmark">${row.adActionMaxPriceAvg?string("#,###,###.##")!}</span></td><!--每日預算-->
						...
						<#list resultSumData as rowSum>
							<tr class="txt-row summaryRow">
								...
								<td data-info-name="">
									<div class="w-full h-full">
										<div class="txt-left pos-middle">
											<span class="amount-event">${rowSum.rowCount?string("#,###,###.##")!}筆廣告活動</span>
										</div>
									</div>
								</td>
								...
								<td data-info-name=""></td>
								<td data-info-name="adActionMaxPriceAvg" class="txt-right"><span class="cost-dollarmark">${rowSum.adActionMaxPriceAvg?string("#,###,###.##")!}</span></td><!--每日預算-->
