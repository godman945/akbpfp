...
<div class="container-prodmanage">
	...
	<div class="nav-wrap pos-relative no-pseudo h-auto">
		<div class="nav-title"><p>總廣告成效</p></div>
	</div>
	<!-- 次目錄導覽列 結束 -->
	...
	<div class="content-wrap p-lr60">
		<div class="content-box p-none">
            ...
            <form id="excerptFrom" name="excerptFrom" action="" method="post">
	            ...
	            <input type="hidden" id="viewType" name="viewType" value="${viewType}"> <#-- 切換廣告成效(campagin)、分類(adGroup)、廣告明細(advertise) -->
	            <input type="hidden" id="adActionSeq" name="adActionSeq"> <#-- 下載報表用 -->
	            <input type="hidden" id="adGroupSeq" name="adGroupSeq"> <#-- 下載報表用 -->
				...
				<div class="nav-wrap prodtable" data-filter="all" data-menu="default" data-list="row" >
					<div class="nav-box pos-relative" >
						...
						<p class="tableform_breadcrumbs" style="display: none;"> <#-- 麵包屑 -->
	                        <span><a href="reportExcerpt.html">總廣告成效</a></span>
	                        <span id="breadcrumbsAdAction"></span>
	                        <span id="breadcrumbsAdGroup" style="display: none;"></span>
	                    </p>
						...
						<ul class="txt-table txt-regular">
							<li class="txt-cell select-menu p-r10" style="display:inline-block;">
								<div class="select-box pos-relative w-130">
									...
									<ul class="menu-items columnType pos-absolute pos-left" style="display:none">
                                        ...
                                        <li data-column-name="adDate" data-select="true"><em></em>走期</li>
	                        ...
	                        <li class="txt-cell group-default">
	                            <div class="input-text">
	                                <input type="text" id="searchText" name="searchText" maxlength="20" value="" required placeholder="搜尋廣告活動名稱">
	                            </div>
	                        </li>
	            ...
	            <div class="prodtable-wrap m-b30" data-filter="all">
	            	<@t.insertAttribute name="excerptDetailList" />
	            </div>
	            <!-- 表格內容 結束 -->
