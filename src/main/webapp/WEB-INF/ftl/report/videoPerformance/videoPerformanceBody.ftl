...
<div class="container-prodmanage">
	...
	<div class="nav-wrap pos-relative no-pseudo h-auto">
		<div class="nav-title"><p>影音廣告成效</p></div>
	</div>
	<!-- 次目錄導覽列 結束 -->
		...
		<div class="content-box p-none">
            ...
            <form id="excerptFrom" name="excerptFrom" action="" method="post">
						...
						<ul class="txt-table txt-regular">
							<li class="txt-cell select-menu p-r10" style="display:inline-block;">
								<div class="select-box pos-relative w-130">
									...
									<ul class="menu-items columnType pos-absolute pos-left" style="display:none">
										...
										<li data-column-name="adVideoProcess" data-select="true"><em></em>影片播放進度</li>
	                                    <li data-column-name="adVideoProcess100Ratings" data-select="true"><em></em>影片完整播放率</li>
	                                    <li data-column-name="adClkSum" data-select="true"><em></em>點選次數</li>
	                                    <li data-column-name="adVideoUniqSum" data-select="true"><em></em>收視人數-不重複</li>
	                                    <li data-column-name="adVideoMusicSum" data-select="true"><em></em>聲音開啟次數</li>
	                                    <li data-column-name="adVideoReplaySum" data-select="true"><em></em>重播次數</li>
									</ul>
								</div>
							</li>
	                        ...
	                        <li class="txt-cell group-default">
	                            <div class="input-text">
	                                <input type="text" id="searchText" name="searchText" maxlength="20" value="" required placeholder="影音廣告名稱 (YOUTUBE影片名稱)">
	                            </div>
	                        </li>
	            ...
	            <div class="prodtable-wrap m-b30" data-filter="all">
	            	<@t.insertAttribute name="videoPerformanceDetailList" />
	            </div>
	            <!-- 表格內容 結束 -->
