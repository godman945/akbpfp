...
//			!(url.indexOf("http://24h.pchome.com.tw/", 0) > -1
...
//			|| 
			...
			//露天商品頁
			|| url.indexOf("http://class.ruten.com.tw/user/index00.php?s=", 0) > -1
			|| url.indexOf("https://class.ruten.com.tw/user/index00.php?s=", 0) > -1)){
		return true;
	}
...
//		$("." + block + " .24h").show();
//	} else 
	if (url.indexOf("seller.pcstore.com.tw") > -1) {
		$("." + block + " .sellerPcstore").show();
	} else if (url.indexOf("pcstore.com.tw") > -1) {
		$("." + block + " .pcstore").show();
	} else if (url.indexOf("ruten.com.tw") > -1) {
		$("." + block + " .ruten").show();
	}
}
