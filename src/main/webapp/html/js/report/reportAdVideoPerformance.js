...
function initShowHideDataListInfo() {
	...
	showHideDataListInfo("adVideoProcess", "false");
	showHideDataListInfo("adVideoProcess100Ratings", "false");
	showHideDataListInfo("adClkSum", "false");
	showHideDataListInfo("adVideoUniqSum", "false");
	showHideDataListInfo("adVideoMusicSum", "false");
	showHideDataListInfo("adVideoReplaySum", "false");
}
...
function processDownloadReport() {
	...
	$("#excerptFrom").attr("action", "reportVideoPerformanceDownload.html");
	$("#excerptFrom").submit();
}
