...
function processQueryAjax(changePageNo) {
	$.ajax({
	    type : "post",
		url : "reportAdWebsiteAjaxTable.html",
	    data: {
...
function processDownloadReport() {
	...
	$("#excerptFrom").attr("action", "reportAdWebsiteDownload.html");
	$("#excerptFrom").submit();
}
...
//var highChartActionPath="reportAdWebsiteAjaxChart.html";
//var reportAjaxActionPath="reportAdWebsiteAjaxTable.html";
////一開始執行
//$(function(){
//
//	//flash chart
...
//	var searchWebsiteCode = document.excerptFrom.searchWebsiteCode.value;
...
//	});
//
//	$("#searchWebsiteCode").children().each(function(){
//		if ($(this).val() == searchWebsiteCode) {
//			//jQuery給法
//			$(this).attr("selected", "true"); //或是給selected也可
//		}
//	});
...
//	});
//	
//	$("#adShowWay, #adPvclkDevice, #adSearchWay, #searchWebsiteCode, #adOperatingRule").change(function(){
//    	searchDo();
//    	ajaxFormSubmit();
//   });
//
...
//			"searchText" : $('#searchText').val(),
//			"searchWebsiteCode" : $('#fadSearchWebsiteCode').val(),
...
//	document.excerptFrom.searchWebsiteCode.value = $('#searchWebsiteCode').val();
