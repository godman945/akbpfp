...
//		templateSizeOptionStr = '<div id="previewselector" class="previewselector">選擇廣告尺寸<select>';
//		var index = 0;
...
//	} else if (adStyle == 'TMG') { // 圖文廣告選擇廣告尺寸
//		showSelectAdSize = true; // 顯示選擇廣告尺寸
...
//		} else {
//			templateSizeOptionStr = '<div id="previewselector" class="previewselector">選擇廣告尺寸'
//								  + '<select onchange="processTMGSelectSize(\'' + $(tempObj).find('#adSeq').val() + '\', this);">'
...
//	
//	// 組中間圖片畫面
//	tempHtmlView = '<div class="predivbox">';
//	if (adStyle == 'IMG') { // 圖像廣告
//		tempHtmlView += '<iframe src="' + $(tempObj).find('#img').val() + '" width="' + tempWidth + '" height="' + tempHeight + '" allowtransparency="true" frameborder="0" scrolling="no"></iframe>';
//	} else if (adStyle == 'VIDEO') { // 影音廣告
//		tempHtmlView += '<iframe scrolling="no" frameborder="0" marginwidth="0" marginheight="0" vspace="0" hspace="0" width="' + tempWidth + '" height="' + tempHeight
...
//				+ '&realUrl=' + $(tempObj).find('#realUrl').val() + '&resize=true\"></iframe>';
//	} else if (adStyle == 'PROD') { // 商品廣告
//		tempHtmlView += '<iframe width="300" height="250" class="akb_iframe" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" vspace="0" hspace="0" id="pchome8044_ad_frame1" allowtransparency="true" allowfullscreen="true"'
...
//			+ '&realUrl=' + $(tempObj).find('#realUrl').val() + '"></iframe>';
//	} else if (adStyle == 'TMG') {
//		tempHtmlView += '<iframe width="' + tempWidth + '" height="' + tempHeight + '" src="adModel.html?adNo=' + $(tempObj).find('#adSeq').val() + '&tproNo=' + $(tempObj).find('#tproNo').val() + '" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" align="ceneter" class="akb_iframe"></iframe>';
//	}
//	
//	tempHtmlView += '</div>';
//	
